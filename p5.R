...
hist(data, col = "blue", main = "GSE5583 = histogram")
...
# ¿Qué es un boxplot?
boxplot(data2, col=c("green", "green", "green", "pink", "pink", "pink"),main="GSE5583 - boxplots")
boxplot(data2,col=c("green","green","green","pink","pink","pink"),main="GSE5583 - Boxplots",las=2)
...
plot(ko.mean ~ wt.mean, xlab = "WT", ylab = "KO", main = "GSE5583 - ScatterPlot",col="blue",xlim=c(0,limit),ylim=c(0,limit))
